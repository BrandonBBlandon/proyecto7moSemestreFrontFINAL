...
export function MetricCard({ label, value, helper, icon: Icon }: MetricCardProps) {
  return (
    <article className="--[1.35rem] border border-white/10 bg-white/[0.055] p-4 shadow-soft">
      <div className="flex items-start justify-between gap-3">
        ...
        {Icon ? (
          <span className="grid h-10 w-10 place-items-center --2xl bg-white/10 text-teal-200">
